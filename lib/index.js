...
var pnpapi__default = /*#__PURE__*/_interopDefaultLegacy(pnpapi);
...
const path_1 = tslib_1.__importDefault(require$$1__default['default']);
var PathType;
(function (PathType) {
...
var copyPromise_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.copyPromise = void 0;

const fs_1 = tslib_1.__importDefault(fs_1__default['default']);
...
async function copySymlink(prelayout, postlayout, updateTime, destinationFs, destination, destinationStat, sourceFs, source, sourceStat, opts) {
    ...
    prelayout.push(async () => {
        await destinationFs.symlinkPromise(path.convertPath(destinationFs.pathUtils, await sourceFs.readlinkPromise(source)), destination);
    });
    return true;
}
});

var FakeFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
    ...
    copySync(destination, source, { baseFs = this, overwrite = true } = {}) {
        ...
        if (stat.isDirectory()) {
            ...
            if (!exists || overwrite) {
                ...
                this.symlinkSync(path.convertPath(this.pathUtils, target), destination);
            }
        }
        else {
...
function getEndOfLine(content) {
    ...
    if (matches === null)
        return os_1__default['default'].EOL;
...
var NodeFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class NodeFS extends FakeFS_1.BasePortableFakeFS {
    ...
    getRealPath() {
        return path.PortablePath.root;
    }
    resolve(p) {
        return path.ppath.resolve(p);
    }
    async openPromise(p, flags, mode) {
        return await new Promise((resolve, reject) => {
            this.realFs.open(path.npath.fromPortablePath(p), flags, mode, this.makeCallback(resolve, reject));
        });
    }
    openSync(p, flags, mode) {
        return this.realFs.openSync(path.npath.fromPortablePath(p), flags, mode);
    }
    async opendirPromise(p, opts) {
        return await new Promise((resolve, reject) => {
            if (typeof opts !== `undefined`) {
                this.realFs.opendir(path.npath.fromPortablePath(p), opts, this.makeCallback(resolve, reject));
            }
            else {
                this.realFs.opendir(path.npath.fromPortablePath(p), this.makeCallback(resolve, reject));
            }
        }).then(dir => {
    ...
    opendirSync(p, opts) {
        const dir = typeof opts !== `undefined`
            ? this.realFs.opendirSync(path.npath.fromPortablePath(p), opts)
            : this.realFs.opendirSync(path.npath.fromPortablePath(p));
        return Object.defineProperty(dir, `path`, { value: p, configurable: true, writable: true });
    }
    ...
    createReadStream(p, opts) {
        const realPath = (p !== null ? path.npath.fromPortablePath(p) : p);
    ...
    async realpathPromise(p) {
        return await new Promise((resolve, reject) => {
            this.realFs.realpath(path.npath.fromPortablePath(p), {}, this.makeCallback(resolve, reject));
        }).then(path$1 => {
            return path.npath.toPortablePath(path$1);
        });
    }
    realpathSync(p) {
        return path.npath.toPortablePath(this.realFs.realpathSync(path.npath.fromPortablePath(p), {}));
    }
    async existsPromise(p) {
        return await new Promise(resolve => {
            this.realFs.exists(path.npath.fromPortablePath(p), resolve);
        });
    }
    accessSync(p, mode) {
        return this.realFs.accessSync(path.npath.fromPortablePath(p), mode);
    }
    async accessPromise(p, mode) {
        return await new Promise((resolve, reject) => {
            this.realFs.access(path.npath.fromPortablePath(p), mode, this.makeCallback(resolve, reject));
        });
    }
    existsSync(p) {
        return this.realFs.existsSync(path.npath.fromPortablePath(p));
    }
    async statPromise(p) {
        return await new Promise((resolve, reject) => {
            this.realFs.stat(path.npath.fromPortablePath(p), this.makeCallback(resolve, reject));
        });
    }
    statSync(p) {
        return this.realFs.statSync(path.npath.fromPortablePath(p));
    }
    async lstatPromise(p) {
        return await new Promise((resolve, reject) => {
            this.realFs.lstat(path.npath.fromPortablePath(p), this.makeCallback(resolve, reject));
        });
    }
    lstatSync(p) {
        return this.realFs.lstatSync(path.npath.fromPortablePath(p));
    }
    async chmodPromise(p, mask) {
        return await new Promise((resolve, reject) => {
            this.realFs.chmod(path.npath.fromPortablePath(p), mask, this.makeCallback(resolve, reject));
        });
    }
    chmodSync(p, mask) {
        return this.realFs.chmodSync(path.npath.fromPortablePath(p), mask);
    }
    async chownPromise(p, uid, gid) {
        return await new Promise((resolve, reject) => {
            this.realFs.chown(path.npath.fromPortablePath(p), uid, gid, this.makeCallback(resolve, reject));
        });
    }
    chownSync(p, uid, gid) {
        return this.realFs.chownSync(path.npath.fromPortablePath(p), uid, gid);
    }
    async renamePromise(oldP, newP) {
        return await new Promise((resolve, reject) => {
            this.realFs.rename(path.npath.fromPortablePath(oldP), path.npath.fromPortablePath(newP), this.makeCallback(resolve, reject));
        });
    }
    renameSync(oldP, newP) {
        return this.realFs.renameSync(path.npath.fromPortablePath(oldP), path.npath.fromPortablePath(newP));
    }
    async copyFilePromise(sourceP, destP, flags = 0) {
        return await new Promise((resolve, reject) => {
            this.realFs.copyFile(path.npath.fromPortablePath(sourceP), path.npath.fromPortablePath(destP), flags, this.makeCallback(resolve, reject));
        });
    }
    copyFileSync(sourceP, destP, flags = 0) {
        return this.realFs.copyFileSync(path.npath.fromPortablePath(sourceP), path.npath.fromPortablePath(destP), flags);
    }
    async appendFilePromise(p, content, opts) {
        return await new Promise((resolve, reject) => {
            const fsNativePath = typeof p === `string` ? path.npath.fromPortablePath(p) : p;
            if (opts) {
    ...
    async unlinkPromise(p) {
        return await new Promise((resolve, reject) => {
            this.realFs.unlink(path.npath.fromPortablePath(p), this.makeCallback(resolve, reject));
        });
    }
    unlinkSync(p) {
        return this.realFs.unlinkSync(path.npath.fromPortablePath(p));
    }
    async utimesPromise(p, atime, mtime) {
        return await new Promise((resolve, reject) => {
            this.realFs.utimes(path.npath.fromPortablePath(p), atime, mtime, this.makeCallback(resolve, reject));
        });
    }
    utimesSync(p, atime, mtime) {
        this.realFs.utimesSync(path.npath.fromPortablePath(p), atime, mtime);
    }
    async lutimesPromiseImpl(p, atime, mtime) {
        // @ts-expect-error: Not yet in DefinitelyTyped
        const lutimes = this.realFs.lutimes;
        if (typeof lutimes === `undefined`)
            throw errors.ENOSYS(`unavailable Node binding`, `lutimes '${p}'`);
        return await new Promise((resolve, reject) => {
            lutimes.call(this.realFs, path.npath.fromPortablePath(p), atime, mtime, this.makeCallback(resolve, reject));
        });
    }
    lutimesSyncImpl(p, atime, mtime) {
        ...
        if (typeof lutimesSync === `undefined`)
            throw errors.ENOSYS(`unavailable Node binding`, `lutimes '${p}'`);
        lutimesSync.call(this.realFs, path.npath.fromPortablePath(p), atime, mtime);
    }
    async mkdirPromise(p, opts) {
        return await new Promise((resolve, reject) => {
            this.realFs.mkdir(path.npath.fromPortablePath(p), opts, this.makeCallback(resolve, reject));
        });
    }
    mkdirSync(p, opts) {
        return this.realFs.mkdirSync(path.npath.fromPortablePath(p), opts);
    }
    async rmdirPromise(p, opts) {
        return await new Promise((resolve, reject) => {
            // TODO: always pass opts when min node version is 12.10+
            if (opts) {
                this.realFs.rmdir(path.npath.fromPortablePath(p), opts, this.makeCallback(resolve, reject));
            }
            else {
                this.realFs.rmdir(path.npath.fromPortablePath(p), this.makeCallback(resolve, reject));
            }
        });
    }
    rmdirSync(p, opts) {
        return this.realFs.rmdirSync(path.npath.fromPortablePath(p), opts);
    }
    async linkPromise(existingP, newP) {
        return await new Promise((resolve, reject) => {
            this.realFs.link(path.npath.fromPortablePath(existingP), path.npath.fromPortablePath(newP), this.makeCallback(resolve, reject));
        });
    }
    linkSync(existingP, newP) {
        return this.realFs.linkSync(path.npath.fromPortablePath(existingP), path.npath.fromPortablePath(newP));
    }
    async symlinkPromise(target, p, type) {
        const symlinkType = type || (target.endsWith(`/`) ? `dir` : `file`);
        return await new Promise((resolve, reject) => {
            this.realFs.symlink(path.npath.fromPortablePath(target.replace(/\/+$/, ``)), path.npath.fromPortablePath(p), symlinkType, this.makeCallback(resolve, reject));
        });
    }
    symlinkSync(target, p, type) {
        const symlinkType = type || (target.endsWith(`/`) ? `dir` : `file`);
        return this.realFs.symlinkSync(path.npath.fromPortablePath(target.replace(/\/+$/, ``)), path.npath.fromPortablePath(p), symlinkType);
    }
    ...
    async readdirPromise(p, { withFileTypes } = {}) {
        return await new Promise((resolve, reject) => {
            if (withFileTypes) {
                this.realFs.readdir(path.npath.fromPortablePath(p), { withFileTypes: true }, this.makeCallback(resolve, reject));
            }
            else {
                this.realFs.readdir(path.npath.fromPortablePath(p), this.makeCallback(value => resolve(value), reject));
            }
        });
    }
    readdirSync(p, { withFileTypes } = {}) {
        if (withFileTypes) {
            return this.realFs.readdirSync(path.npath.fromPortablePath(p), { withFileTypes: true });
        }
        else {
            return this.realFs.readdirSync(path.npath.fromPortablePath(p));
        }
    }
    async readlinkPromise(p) {
        return await new Promise((resolve, reject) => {
            this.realFs.readlink(path.npath.fromPortablePath(p), this.makeCallback(resolve, reject));
        }).then(path$1 => {
            return path.npath.toPortablePath(path$1);
        });
    }
    readlinkSync(p) {
        return path.npath.toPortablePath(this.realFs.readlinkSync(path.npath.fromPortablePath(p)));
    }
    async truncatePromise(p, len) {
        return await new Promise((resolve, reject) => {
            this.realFs.truncate(path.npath.fromPortablePath(p), len, this.makeCallback(resolve, reject));
        });
    }
    truncateSync(p, len) {
        return this.realFs.truncateSync(path.npath.fromPortablePath(p), len);
    }
    watch(p, a, b) {
        return this.realFs.watch(path.npath.fromPortablePath(p), 
        // @ts-expect-error
        a, b);
    }
    watchFile(p, a, b) {
        return this.realFs.watchFile(path.npath.fromPortablePath(p), 
        // @ts-expect-error
        a, b);
    }
    unwatchFile(p, cb) {
        return this.realFs.unwatchFile(path.npath.fromPortablePath(p), cb);
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.S_IFLNK = exports.S_IFREG = exports.S_IFDIR = exports.S_IFMT = void 0;
...
var statUtils = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.areStatsEqual = exports.makeEmptyStats = exports.makeDefaultStats = exports.StatEntry = exports.DirEntry = void 0;
...
var opendir_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.opendir = exports.CustomDir = void 0;

const errors$1 = tslib_1.__importStar(errors);
class CustomDir {
...
var CustomStatWatcher_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.CustomStatWatcher = exports.assertStatus = exports.Status = exports.Event = void 0;


const statUtils$1 = tslib_1.__importStar(statUtils);
var Event;
(function (Event) {
    Event["Change"] = "change";
    Event["Stop"] = "stop";
...
class CustomStatWatcher extends events_1__default['default'].EventEmitter {
    ...
    stat() {
        try {
            ...
            if (error.code === `ENOENT`) {
                return statUtils$1.makeEmptyStats();
            }
            else {
                throw error;
            }
    ...
    makeInterval(opts) {
        const interval = setInterval(() => {
            ...
            if (statUtils$1.areStatsEqual(currentStats, previousStats))
                return;
...
var watchFile_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var ZipFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
const zlib_1 = tslib_1.__importDefault(require$$0__default['default']);
...
function toUnixTimestamp(time) {
    ...
    if (util_1__default['default'].isDate(time))
...
class ZipFS extends FakeFS_1.BasePortableFakeFS {
    constructor(source, opts) {
            ...
            if (typeof source === `string`) {
                try {
                    ...
                    if (error.code === `ENOENT` && pathOptions.create) {
                        this.stats = statUtils$1.makeDefaultStats();
                    }
                    else {
                        throw error;
                    }
        ...
        try {
            ...
            if (typeof source === `string`) {
                this.zip = this.libzip.open(path.npath.fromPortablePath(source), flags, errPtr);
            }
            else {
        ...
        this.listings.set(path.PortablePath.root, new Set());
        const entryCount = this.libzip.getNumEntries(this.zip, 0);
        for (let t = 0; t < entryCount; ++t) {
            const raw = this.libzip.getName(this.zip, t, 0);
            if (path.ppath.isAbsolute(raw))
                continue;
            const p = path.ppath.resolve(path.PortablePath.root, raw);
    ...
    makeLibzipError(error) {
        ...
        const libzipError = new errors$1.LibzipError(strerror, this.libzip.errors[errorCode]);
    ...
    prepareClose() {
        if (!this.ready)
            throw errors$1.EBUSY(`archive closed, close`);
    ...
    resolve(p) {
        return path.ppath.resolve(path.PortablePath.root, p);
    }
    async openPromise(p, flags, mode) {
    ...
    opendirSync(p, opts = {}) {
        ...
        if (!this.entries.has(resolvedP) && !this.listings.has(resolvedP))
            throw errors$1.ENOENT(`opendir '${p}'`);
        const directoryListing = this.listings.get(resolvedP);
        if (!directoryListing)
            throw errors$1.ENOTDIR(`opendir '${p}'`);
        const entries = [...directoryListing];
        const fd = this.openSync(resolvedP, `r`);
        const onClose = () => {
            this.closeSync(fd);
        };
        return opendir_1.opendir(this, resolvedP, entries, { onClose });
    }
    ...
    createReadStream(p, { encoding } = {}) {
        ...
        const stream = Object.assign(new stream_1__default['default'].PassThrough({
            emitClose: true,
            autoDestroy: true,
    ...
    existsSync(p) {
        if (!this.ready)
            throw errors$1.EBUSY(`archive closed, existsSync '${p}'`);
        if (this.symlinkCount === 0) {
            const resolvedP = path.ppath.resolve(path.PortablePath.root, p);
    ...
    accessSync(p, mode = fs_1__default['default'].constants.F_OK) {
        const resolvedP = this.resolveFilename(`access '${p}'`, p);
        if (!this.entries.has(resolvedP) && !this.listings.has(resolvedP))
            throw errors$1.ENOENT(`access '${p}'`);
        if (this.readOnly && (mode & fs_1__default['default'].constants.W_OK)) {
            throw errors$1.EROFS(`access '${p}'`);
        }
    }
    async statPromise(p) {
    ...
    statSync(p) {
        ...
        if (!this.entries.has(resolvedP) && !this.listings.has(resolvedP))
            throw errors$1.ENOENT(`stat '${p}'`);
        if (p[p.length - 1] === `/` && !this.listings.has(resolvedP))
            throw errors$1.ENOTDIR(`stat '${p}'`);
    ...
    lstatSync(p) {
        ...
        if (!this.entries.has(resolvedP) && !this.listings.has(resolvedP))
            throw errors$1.ENOENT(`lstat '${p}'`);
        if (p[p.length - 1] === `/` && !this.listings.has(resolvedP))
            throw errors$1.ENOTDIR(`lstat '${p}'`);
    ...
    statImpl(reason, p) {
        ...
        if (typeof entry !== `undefined`) {
            ...
            return Object.assign(new statUtils$1.StatEntry(), { uid, gid, size, blksize, blocks, atime, birthtime, ctime, mtime, atimeMs, birthtimeMs, ctimeMs, mtimeMs, mode });
        }
        // Implicit directory
    ...
    registerListing(p) {
        ...
        if (listing)
            return listing;
        const parentListing = this.registerListing(path.ppath.dirname(p));
        listing = new Set();
        parentListing.add(path.ppath.basename(p));
    ...
    unregisterListing(p) {
        ...
        const parentListing = this.listings.get(path.ppath.dirname(p));
        parentListing === null || parentListing === void 0 ? void 0 : parentListing.delete(path.ppath.basename(p));
    }
    unregisterEntry(p) {
    ...
    resolveFilename(reason, p, resolveLastComponent = true) {
        if (!this.ready)
            throw errors$1.EBUSY(`archive closed, ${reason}`);
        let resolvedP = path.ppath.resolve(path.PortablePath.root, p);
        if (resolvedP === `/`)
            return path.PortablePath.root;
        ...
        if (resolveLastComponent && fileIndex !== undefined) {
            if (this.symlinkCount !== 0 && this.isSymbolicLink(fileIndex)) {
                ...
                return this.resolveFilename(reason, path.ppath.resolve(path.ppath.dirname(resolvedP), target), true);
            }
            else {
                return resolvedP;
            }
        ...
        while (true) {
            const parentP = this.resolveFilename(reason, path.ppath.dirname(resolvedP), true);
            const isDir = this.listings.has(parentP);
            const doesExist = this.entries.has(parentP);
            if (!isDir && !doesExist)
                throw errors$1.ENOENT(reason);
            if (!isDir)
                throw errors$1.ENOTDIR(reason);
            resolvedP = path.ppath.resolve(parentP, path.ppath.basename(resolvedP));
            ...
            if (this.isSymbolicLink(index)) {
                ...
                resolvedP = path.ppath.resolve(path.ppath.dirname(resolvedP), target);
            }
            else {
                break;
            }
    ...
    setFileSource(p, content) {
        ...
        const target = path.ppath.relative(path.PortablePath.root, p);
    ...
    prepareCopyFile(sourceP, destP, flags = 0) {
        if (this.readOnly)
            throw errors$1.EROFS(`copyfile '${sourceP} -> '${destP}'`);
        if ((flags & fs_1__default['default'].constants.COPYFILE_FICLONE_FORCE) !== 0)
            throw errors$1.ENOSYS(`unsupported clone operation`, `copyfile '${sourceP}' -> ${destP}'`);
        const resolvedSourceP = this.resolveFilename(`copyfile '${sourceP} -> ${destP}'`, sourceP);
        const indexSource = this.entries.get(resolvedSourceP);
        if (typeof indexSource === `undefined`)
            throw errors$1.EINVAL(`copyfile '${sourceP}' -> '${destP}'`);
        const resolvedDestP = this.resolveFilename(`copyfile '${sourceP}' -> ${destP}'`, destP);
        const indexDest = this.entries.get(resolvedDestP);
        if ((flags & (fs_1__default['default'].constants.COPYFILE_EXCL | fs_1__default['default'].constants.COPYFILE_FICLONE_FORCE)) !== 0 && typeof indexDest !== `undefined`)
            throw errors$1.EEXIST(`copyfile '${sourceP}' -> '${destP}'`);
        return {
            indexSource,
            resolvedDestP,
            indexDest,
    ...
    unlinkSync(p) {
        if (this.readOnly)
            throw errors$1.EROFS(`unlink '${p}'`);
        const resolvedP = this.resolveFilename(`unlink '${p}'`, p);
        if (this.listings.has(resolvedP))
            throw errors$1.EISDIR(`unlink '${p}'`);
        const index = this.entries.get(resolvedP);
        if (typeof index === `undefined`)
            throw errors$1.EINVAL(`unlink '${p}'`);
    ...
    lutimesSync(p, atime, mtime) {
        if (this.readOnly)
            throw errors$1.EROFS(`lutimes '${p}'`);
    ...
    mkdirSync(p, { mode = 0o755, recursive = false } = {}) {
        ...
        if (this.readOnly)
            throw errors$1.EROFS(`mkdir '${p}'`);
        const resolvedP = this.resolveFilename(`mkdir '${p}'`, p);
        if (this.entries.has(resolvedP) || this.listings.has(resolvedP))
            throw errors$1.EEXIST(`mkdir '${p}'`);
        this.hydrateDirectory(resolvedP);
    ...
    rmdirSync(p, { recursive = false } = {}) {
        ...
        const directoryListing = this.listings.get(resolvedP);
        if (!directoryListing)
            throw errors$1.ENOTDIR(`rmdir '${p}'`);
        if (directoryListing.size > 0)
            throw errors$1.ENOTEMPTY(`rmdir '${p}'`);
        const index = this.entries.get(resolvedP);
        if (typeof index === `undefined`)
            throw errors$1.EINVAL(`rmdir '${p}'`);
        this.deleteEntry(p, index);
    }
    hydrateDirectory(resolvedP) {
        const index = this.libzip.dir.add(this.zip, path.ppath.relative(path.PortablePath.root, resolvedP));
        if (index === -1)
            throw this.makeLibzipError(this.libzip.getError(this.zip));
    ...
    linkSync(existingP, newP) {
        ...
        throw errors$1.EOPNOTSUPP(`link '${existingP}' -> '${newP}'`);
    }
    ...
    symlinkSync(target, p) {
        if (this.readOnly)
            throw errors$1.EROFS(`symlink '${target}' -> '${p}'`);
        const resolvedP = this.resolveFilename(`symlink '${target}' -> '${p}'`, p);
        if (this.listings.has(resolvedP))
            throw errors$1.EISDIR(`symlink '${target}' -> '${p}'`);
        if (this.entries.has(resolvedP))
            throw errors$1.EEXIST(`symlink '${target}' -> '${p}'`);
    ...
    readFileBuffer(p, opts = { asyncDecompress: false }) {
        ...
        if (p[p.length - 1] === `/` && !this.listings.has(resolvedP))
            throw errors$1.ENOTDIR(`open '${p}'`);
        if (this.listings.has(resolvedP))
            throw errors$1.EISDIR(`read`);
        const entry = this.entries.get(resolvedP);
        if (entry === undefined)
            throw new Error(`Unreachable`);
    ...
    readdirSync(p, { withFileTypes } = {}) {
        ...
        if (!this.entries.has(resolvedP) && !this.listings.has(resolvedP))
            throw errors$1.ENOENT(`scandir '${p}'`);
        const directoryListing = this.listings.get(resolvedP);
        if (!directoryListing)
            throw errors$1.ENOTDIR(`scandir '${p}'`);
        const entries = [...directoryListing];
        if (!withFileTypes)
            return entries;
        return entries.map(name => {
            return Object.assign(this.statImpl(`lstat`, path.ppath.join(p, name)), {
                name,
            });
        });
    }
...
var ProxiedFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var AliasFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var CwdFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class CwdFS extends ProxiedFS_1.ProxiedFS {
    ...
    resolve(p) {
        if (this.pathUtils.isAbsolute(p)) {
            return path.ppath.normalize(p);
        }
        else {
            return this.baseFs.resolve(path.ppath.join(this.target, p));
        }
    }
    mapFromBase(path) {
        return path;
...
var JailFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.JailFS = void 0;



const JAIL_ROOT = path.PortablePath.root;
class JailFS extends ProxiedFS_1.ProxiedFS {
    constructor(target, { baseFs = new NodeFS_1.NodeFS() } = {}) {
        super(path.ppath);
        this.target = this.pathUtils.resolve(path.PortablePath.root, target);
        this.baseFs = baseFs;
    }
    getRealPath() {
        return this.pathUtils.resolve(this.baseFs.getRealPath(), this.pathUtils.relative(path.PortablePath.root, this.target));
    }
    getTarget() {
        return this.target;
    }
...
var LazyFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var NoFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.NoFS = void 0;
...
var PosixFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class PosixFS extends ProxiedFS_1.ProxiedFS {
    ...
    mapFromBase(path$1) {
        return path.npath.fromPortablePath(path$1);
    }
    mapToBase(path$1) {
        return path.npath.toPortablePath(path$1);
    }
...
var VirtualFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class VirtualFS extends ProxiedFS_1.ProxiedFS {
    ...
    static makeVirtualPath(base, component, to) {
        ...
        const fullVirtualPath = path.ppath.join(base, component, String(depth), ...finalSegments);
    ...
    static resolveVirtual(p) {
        ...
        if (!match || (!match[3] && match[5]))
            return p;
        const target = path.ppath.dirname(match[1]);
        if (!match[3] || !match[4])
            return target;
        ...
        return VirtualFS.resolveVirtual(path.ppath.join(target, backstep, subpath));
    }
    getExtractHint(hints) {
        return this.baseFs.getExtractHint(hints);
    }
...
var ZipOpenFS_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class ZipOpenFS extends FakeFS_1.BasePortableFakeFS {
    ...
    async realpathPromise(p) {
        return await this.makeCallPromise(p, async () => {
            ...
            return this.pathUtils.join(realArchivePath, this.pathUtils.relative(path.PortablePath.root, await zipFs.realpathPromise(subPath)));
        });
    }
    realpathSync(p) {
        return this.makeCallSync(p, () => {
            ...
            return this.pathUtils.join(realArchivePath, this.pathUtils.relative(path.PortablePath.root, zipFs.realpathSync(subPath)));
        });
    }
    async existsPromise(p) {
        return await this.makeCallPromise(p, async () => {
    ...
    async copyFilePromise(sourceP, destP, flags = 0) {
        const fallback = async (sourceFs, sourceP, destFs, destP) => {
            ...
            if ((flags & fs_1__default['default'].constants.COPYFILE_EXCL) && await this.existsPromise(sourceP))
    ...
    copyFileSync(sourceP, destP, flags = 0) {
        const fallback = (sourceFs, sourceP, destFs, destP) => {
            if ((flags & fs_1__default['default'].constants.COPYFILE_FICLONE_FORCE) !== 0)
                throw Object.assign(new Error(`EXDEV: cross-device clone not permitted, copyfile '${sourceP}' -> ${destP}'`), { code: `EXDEV` });
            if ((flags & fs_1__default['default'].constants.COPYFILE_EXCL) && this.existsSync(sourceP))
                throw Object.assign(new Error(`EEXIST: file already exists, copyfile '${sourceP}' -> '${destP}'`), { code: `EEXIST` });
            let content;
            try {
    ...
    findZip(p) {
        ...
        while (true) {
            ...
            return {
                ...
                subPath: this.pathUtils.join(path.PortablePath.root, p.substr(filePath.length)),
            };
        }
    }
    limitOpenFiles(max) {
...
const os_1 = tslib_1.__importDefault(os_1__default['default']);



const statUtils$1 = tslib_1.__importStar(statUtils);
exports.statUtils = statUtils$1;
...
function getTempName(prefix) {
    const tmpdir = path.npath.toPortablePath(os_1.default.tmpdir());
    const hash = Math.ceil(Math.random() * 0x100000000).toString(16).padStart(8, `0`);
    return path.ppath.join(tmpdir, `${prefix}${hash}`);
}
function patchFs(patchedFs, fakeFs) {
    ...
    const setupFn = (target, name, replacement) => {
        ...
        if (typeof (orig === null || orig === void 0 ? void 0 : orig[util_1__default['default'].promisify.custom]) !== `undefined`) {
            replacement[util_1__default['default'].promisify.custom] = orig[util_1__default['default'].promisify.custom];
        }
    };
    ...
    /** util.promisify implementations */
    {
        ...
        // @ts-expect-error
        patchedFs.read[util_1__default['default'].promisify.custom] = async (p, buffer, ...args) => {
...
var makeInterface_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var libzipSync = createCommonjsModule(function (module) {
var frozenFs = Object.assign({}, fs_1__default['default']);
...
{
  var fs = frozenFs;
  var NODEJS_PATH = require$$1__default['default'];
  NODEFS.staticInit();
}
{
...
function getLibzipSync() {
    if (mod === null)
        mod = makeInterface_1.makeInterface(libzipSync);
    return mod;
}
...
var libzip = /*@__PURE__*/getDefaultExportFromCjs(sync);

function index (options) {
	return (url, prev, done) => {
		const zipOpenFs = new lib.ZipOpenFS({ libzip: libzip.getLibzipSync() });
		const crossFs = new lib.PosixFS(zipOpenFs);
		const res = pnpapi__default['default'].resolveRequest(url, options.dirname + "/");
